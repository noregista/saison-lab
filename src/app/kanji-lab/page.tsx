...
export default function KanjiLabPage() {
    ...
    return (
        <main className="min-h-screen bg-[#0d1117] text-white relative">
            {/* Background Image */}
            <div
                className="absolute inset-0 z-0 bg-cover bg-center opacity-15 pointer-events-none mix-blend-overlay"
                style={{ backgroundImage: 'url("/kanji-lab/bg-calligraphy.png")' }}
            />
            {/* Content Wrapper */}
