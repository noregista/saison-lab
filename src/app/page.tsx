...
const translations = {
    jp: {
        ...
        'app-sushi-lab-desc': '寿司の種類、マナー、注文方法を視覚的かつ直感的に解説するデジタルハンドブック。',
        'app-unit-lab-desc': '国際標準から尺貫法まで網羅した多機能単位アーカイブ。視覚的比較機能付き。',
        ...
        'update-17': 'CUISINE LABを追加しました。',
        'update-18': 'TEMPLE LABを追加しました。',
        'update-18': 'SUSHI LABを追加しました。',
        'update-19': 'UNIT LABを追加しました。',
    ...
    en: {
        ...
        'app-sushi-lab-desc': 'A digital handbook explaining sushi types,
        'app-unit-lab-desc': 'Multifunctional unit archive covering everything from SI to traditional units. Features visual comparisons.', etiquette, and ordering visually and intuitively.',
        ...
        'update-17': 'Added CUISINE LAB.',
        'update-18': 'Added TEMPLE LAB.',
        'update-18': 'Added SUSHI LAB.',
        'update-19': 'Added UNIT LAB.',
