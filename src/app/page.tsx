...
const translations = {
    jp: {
        ...
        'app-gallery-one-desc': '18種類のフォトフレームで写真を美しく装飾。高品質PNG出力。',
        'app-nagisa-kaede-desc': '凪沙 楓 公式サイト。ニュース、楽曲、動画、ギャラリーをお届け。',
        ...
        'app-language-atlas-desc': '世界15言語の分布をインタラクティブ地図で探索。',
        'app-global-plate-desc': '世界の主食（米・小麦・芋類等）の歴史、分布、栄養学的特徴を地図と皿のUIで探索。',
        'app-kanji-lab-desc': '小学1年生から6年生までの学習漢字1026文字を網羅したデジタル漢字ドリル。',
        'app-rhyme-lab-desc': '日本語の韻を検索・分析。作詞やラップ制作を強力に支援するライミングツール。',
        'app-sushi-lab-desc': '寿司の種類、魚の旬、マナー、注文方法を視覚的かつ直感的に解説するデジタルハンドブック。',
        'app-temple-lab-desc': '日本各地の寺院を歴史・建築・体験の3軸で紹介するデジタル・ポータル。',
        'app-cuisine-lab-desc': '世界各国の代表料理TOP3を「言葉」だけで味わう美食カタログ。',
        'app-unit-lab-desc': '長さ、重さ、温度など、あらゆる単位を即座に相互変換する便利ツール。',
        'app-magic-lab-desc': 'スクロール禁止。1画面に収まる「魔法の書斎」。暖炉の炎、本棚の古書、浮遊する火の粉…クリックで魔法発動。',
        ...
        'update-2': '画像分割ツール Splitterを追加しました。',
        'update-3': 'ネオ・クロニクルを追加しました。',
        'update-4': '戦争日記 / 江戸動乱之記録を追加しました。',
        'update-5': 'THE BUTTONを追加しました。',
        'update-6': 'フォント・ラボを追加しました。',
        'update-7': 'ギャラリー・ワンを追加しました。',
        'update-8': '凪沙 楓 公式サイトを追加しました。',
        'update-9': 'PIANO LABを追加しました。',
        'update-10': 'SYNTH LAB / XYLOPHONE LAB / DRUM LABを追加しました。',
        'update-11': 'LANGUAGE ATLASを追加しました。',
        'update-12': 'KANJI LABを追加しました。',
        'update-13': 'RHYME LABを追加しました。',
        'update-14': 'UNIT LABを追加しました。',
        'update-15': 'GLOBAL PLATEを追加しました。',
        'update-16': 'CUISINE LABを追加しました。',
        'update-17': 'TEMPLE LABを追加しました。',
        'update-18': 'SUSHI LABを追加しました。',
        'update-19': 'アプリ一覧を更新しました。',
        'update-20': 'RANKING LABを追加しました。',
        'update-21': 'MAGIC LABを追加しました。',
    ...
    en: {
        ...
        'app-gallery-one-desc': 'Decorate your photos with 18 unique frames. High-quality PNG export.',
        'app-nagisa-kaede-desc': 'Official site of Nagisa Kaede. News, music, videos, and gallery.',
        ...
        'app-language-atlas-desc': 'Explore 15 world languages on an interactive map.',
        'app-global-plate-desc': 'Explore the history, distribution, and nutrition of world staple foods (rice, wheat, tubers) with map and plate UI.',
        'app-kanji-lab-desc': 'Digital Kanji drill covering 1026 characters learned in Japanese elementary schools.',
        'app-rhyme-lab-desc': 'Search and analyze Japanese rhymes. A riming tool for lyricists and rappers.',
        'app-sushi-lab-desc': 'A digital handbook explaining sushi types, fish seasons, etiquette, and ordering visually.',
        'app-temple-lab-desc': 'Digital portal exploring famous Japanese temples through History, Architecture & Experience.',
        'app-cuisine-lab-desc': 'A gastronomic catalog savoring the TOP 3 signature dishes from around the world through "words" alone.',
        'app-unit-lab-desc': 'A handy tool to instantly convert length, weight, temperature, and more.',
        'app-magic-lab-desc': 'No scrolling. A magical study room in one screen. Crackling fireplace, ancient books, floating embers... Magic activates on click.',
        ...
        'update-5': 'Added THE BUTTON.',
        'update-6': 'Added FONT LAB.',
        'update-7': 'Added GALLERY ONE.',
        'update-8': 'Added NAGISA KAEDE Official.',
        'update-9': 'Added PIANO LAB.',
        'update-10': 'Added SYNTH LAB / XYLOPHONE LAB / DRUM LAB.',
        'update-11': 'Added LANGUAGE ATLAS.',
        'update-12': 'Added KANJI LAB.',
        'update-13': 'Added RHYME LAB.',
        'update-14': 'Added UNIT LAB.',
        'update-15': 'Added GLOBAL PLATE.',
        'update-16': 'Added CUISINE LAB.',
        'update-17': 'Added TEMPLE LAB.',
        'update-18': 'Added SUSHI LAB.',
        'update-19': 'Updated app lineup.',
        'update-20': 'Added RANKING LAB.',
        'update-21': 'Added MAGIC LAB.',
        'update-22': 'Added DIGITAL ART LAB.',
        'update-23': 'Added FRUIT LAB.',
        'update-24': 'Added NAME LAB.',
...
const apps = [
    ...
    {
        id: 'gallery-one',
        name: { jp: 'ギャラリー・ワン', en: 'GALLERY ONE' },
        href: '/gallery-one',
        icon: '🖼️',
        descKey: 'app-gallery-one-desc' as const,
    },
    {
        id: 'nagisa-kaede',
        name: { jp: '凪沙 楓', en: 'NAGISA KAEDE' },
        href: '/nagisa-kaede',
        icon: '🍁',
        descKey: 'app-nagisa-kaede-desc' as const,
    },
    {
        id: 'piano-lab',
    ...
    {
        id: 'language-atlas',
        name: { jp: '言語図鑑', en: 'LANGUAGE ATLAS' },
        href: '/language-atlas',
        icon: '🌐',
        descKey: 'app-language-atlas-desc' as const,
    },
    {
        id: 'global-plate',
        name: { jp: 'グローバル・プレート', en: 'GLOBAL PLATE' },
        href: '/global-plate',
        icon: '🍽️',
        descKey: 'app-global-plate-desc' as const,
    },
    {
        id: 'kanji-lab',
        name: { jp: '漢字ラボ', en: 'KANJI LAB' },
        href: '/kanji-lab',
        icon: '漢',
        descKey: 'app-kanji-lab-desc' as const,
    },
    {
        id: 'rhyme-lab',
        name: { jp: 'ライム・ラボ', en: 'RHYME LAB' },
        href: '/rhyme-lab',
        icon: '🎤',
        descKey: 'app-rhyme-lab-desc' as const,
    },
    {
        id: 'sushi-lab',
        name: { jp: '寿司ラボ', en: 'SUSHI LAB' },
        href: '/sushi-lab/index.html',
        icon: '🍣',
        descKey: 'app-sushi-lab-desc' as const,
    },
    {
        id: 'temple-lab',
        name: { jp: 'テンプル・ラボ', en: 'TEMPLE LAB' },
        href: '/temple-lab/index.html',
        icon: '🏯',
        descKey: 'app-temple-lab-desc' as const,
    },
    {
        id: 'cuisine-lab',
        name: { jp: 'キュイジーヌ・ラボ', en: 'CUISINE LAB' },
        href: '/cuisine-lab/index.html',
        icon: '🥘',
        descKey: 'app-cuisine-lab-desc' as const,
    },
    {
        id: 'unit-lab',
        name: { jp: 'ユニット・ラボ', en: 'UNIT LAB' },
        href: '/unit-lab/index.html',
        icon: '📏',
    ...
    {
        id: 'magic-lab',
        name: { jp: 'マジック・ラボ', en: 'MAGIC LAB' },
        href: '/magic-lab',
        icon: '🪄',
        descKey: 'app-magic-lab-desc' as const,
    },
    {
        id: 'digital-art-lab',
        name: { jp: 'デジタル・アート・ラボ', en: 'DIGITAL ART LAB' },
        href: '/digital-art-lab',
        icon: '✨',
        descKey: 'app-digital-art-lab-desc' as const,
    },
    {
        id: 'fruit-lab',
...
const updates = [
    { date: '2026.01.18', key: 'update-22' as const },
    { date: '2026.01.18', key: 'update-21' as const },
    ...
    { date: '2026.01.17', key: 'update-16' as const },
    { date: '2026.01.17', key: 'update-15' as const },
    { date: '2026.01.17', key: 'update-14' as const },
    { date: '2026.01.17', key: 'update-13' as const },
    { date: '2026.01.17', key: 'update-12' as const },
    { date: '2026.01.17', key: 'update-11' as const },
    { date: '2026.01.17', key: 'update-10' as const },
    { date: '2026.01.17', key: 'update-9' as const },
    { date: '2026.01.17', key: 'update-8' as const },
    { date: '2026.01.17', key: 'update-7' as const },
