...
const translations = {
    jp: {
        ...
        'app-kanji-lab-desc': '13,000以上の漢字を検索・学習。読み、画数、部首、熟語、JLPTレベルまで網羅。',
        'app-the-brew-desc': '世界15種のお茶と最適な淌れ方。温度・時間・タイマー付き。',
        'app-rhyme-lab-desc': '韻を踏める単語を簡単検索。ラップ、詩、キャッチコピー作成に。日本語・英語対応。',
        'app-weather-lab-desc': '世界15都市のリアルタイム気象データ。ヒートマップ地図。',
        ...
        'update-13': 'THE BREWを追加しました。',
        'update-14': 'RHYME LABを追加しました。',
        'update-15': 'WEATHER LABを追加しました。',
        'update-16': 'GLOBAL PLATEを追加しました。',
    ...
    en: {
        ...
        'app-kanji-lab-desc': 'Search & learn 13,000+ kanji. Readings, strokes, radicals, vocabulary, and JLPT levels.',
        'app-the-brew-desc': '15 world teas with optimal brewing. Temperature, time, and built-in timer.',
        'app-rhyme-lab-desc': 'Find rhyming words easily. For rap, poetry, and copywriting. Japanese & English supported.',
        'app-weather-lab-desc': 'Real-time weather data for 15 world cities. Heatmap visualization.',
        ...
        'update-13': 'Added THE BREW.',
        'update-14': 'Added RHYME LAB.',
        'update-15': 'Added WEATHER LAB.',
        'update-16': 'Added GLOBAL PLATE.',
...
const apps = [
    ...
    {
        id: 'the-brew',
        name: { jp: 'ザ・ブリュー', en: 'THE BREW' },
        href: '/the-brew',
        icon: '🍵',
        descKey: 'app-the-brew-desc' as const,
    },
    {
        id: 'rhyme-lab',
    ...
    {
        id: 'weather-lab',
        name: { jp: 'ウェザー・ラボ', en: 'WEATHER LAB' },
        href: '/weather-lab',
        icon: '⛅',
        descKey: 'app-weather-lab-desc' as const,
    },
    {
        id: 'global-plate',
